...
void loop(){
    ...
    float xTargetApproach = 100;
    float yTargetApproach = 150;
    float zTargetApproach = -50;

    float xTargetPick = 100;
    float yTargetPick = 150;
    float zTargetPick = 85;
    
    float xTargetPlace1 = -70;
    float yTargetPlace1 = 100;
    float zTargetPlace1 = -50;

    float xTargetPlace2 = -70;
    float yTargetPlace2 = 100;
    ...
    trajectoryPlan(startxTarget, startyTarget, startzTarget,
                     xTargetApproach, yTargetApproach, zTargetApproach);
    ...
    //Place_1
    delay(delayTime);
    trajectoryPlan(xTargetPick, yTargetPick, zTargetPick,
                    xTargetPlace1, yTargetPlace1, zTargetPlace1);
    
    //Place_2
    delay(delayTime);
    trajectoryPlan(xTargetPlace1, yTargetPlace1, zTargetPlace1,
                    xTargetPlace2, yTargetPlace2, zTargetPlace2);
    Gripper.write(GripperOpen);

    //Start 
    delay(delayTime);
    trajectoryPlan(xTargetPlace2, yTargetPlace2, zTargetPlace2,
                    startxTarget, startyTarget, startzTarget);
}
